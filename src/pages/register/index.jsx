...
import { Background, Container, Column, Title, SubtitleLogin } from "./styles";
      ...
      <Column>
        ...
        <Column>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Input name="Nome completo" errorMessage={errors?.email?.message} control={control} placeholder="Nome Completo"/>
